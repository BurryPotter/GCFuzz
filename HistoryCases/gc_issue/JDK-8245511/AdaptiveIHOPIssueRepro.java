 ...
 * humongous allocations:     35 MB/s - 35 objects/s 
 * 
 ...
 */
public class AdaptiveIHOPIssueRepro {
    ...
    static final int HUMONGOUS_OBJECT_SIZE = REGION_SIZE;
    static final int YOUNG_OBJECT_SIZE = 2 * K;

    static final int HUMONGOUS_ALLOCATION_RATE = 35 * M;
    ...
    public static void main(String[] args) throws InterruptedException {
        final int humongousAllocationsPerSecond = HUMONGOUS_ALLOCATION_RATE / HUMONGOUS_OBJECT_SIZE;
